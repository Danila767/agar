// ==UserScript==
// @name        Danila767Bot
// @namespace   Danila767Bot
// @include     http://agar.io/
// @version     2.20
// @grant       none
// @author      youtube.com/Danila767
// ==/UserScript==
...
console.log("Running Danila767 Bot!");
(function(f, g) {
    var splitDistance = 710;
    console.log("Danila767 Bot!");
    ...
    f.botList.push(["Danila767Bot", findDestination]);

    var bList = g('#bList');
    g('<option />', {value: (f.botList.length - 1), text: "Danila767Bot"}).appendTo(bList);
